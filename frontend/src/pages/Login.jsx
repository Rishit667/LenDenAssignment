...
const Login = () => {
  ...
  const handleInputChange = (e) => {
    ...
    if(formState.errors[name]) {
      setFormState(prev => ({...prev,error:{...prev.errors,[name]:''}}))
    }
  }
    ...
    try {
      ...
      setFormState(prev => (
        {...prev,
          loading:false,
          errors : {
            submit : error.response?.data?.message || 'login failed Pease check your credentials'
          }
        }));
        ...
        <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          <div className='text-center'>
            <p className='text-gray-600'>
              ...
              <a href='/' className='text-blue-600 hover:text-blue-700 font-medium'>Create one here</a>
            </p>
          </div>
          </form>
      </div>
